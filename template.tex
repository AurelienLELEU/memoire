...
\usepackage{xcolor}
\usepackage{fancyvrb}
% Note: the Shaded / Highlighting environments are injected by Pandoc via
% $highlighting-macros$ below (when --highlight-style is active). Do not
% redefine them here, otherwise LaTeX errors with "Command \Shaded already
% defined".
