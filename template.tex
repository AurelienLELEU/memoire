...
% En mode twoside, pagination extérieure (gauche sur page paire, droite sur page impaire)
% et titre courant en bas de page externe pour ne pas surcharger la marge supérieure.
\usepackage{fancyhdr}
\pagestyle{fancy}
\fancyhf{}
...
% Même style sur les pages démarrant un nouveau chapitre/partie
